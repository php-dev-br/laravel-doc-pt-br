...
Of course, manually specifying the attributes for each model seed is cumbersome. Instead, you can use [model factories](database-testing.md#defining-model-factories) to conveniently generate large amounts of database records. First, review the [model factory documentation](database-testing.md#defining-model-factories) to learn how to define your factories.

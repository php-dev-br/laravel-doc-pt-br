...
a [`LazyCollection`](collections.md#lazy-collections), which lets you interact
...
supported by SQLite database versions less than 3.38.0:
...
To build more advanced `having` statements, see the [`havingRaw`](#raw-methods)
method.

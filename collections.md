...
This method is especially useful in [views](views.md) when working with a grid system such as [Bootstrap](https://getbootstrap.com/css/#grid). Imagine you have a collection of [Eloquent](eloquent.md) models you want to display in a grid:

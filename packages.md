...
To learn more about the structure and purpose of service providers, check out [their documentation](providers.md).

<a name="routing"></a>
## Routing

To define routes for your package, simply `require` the routes file from within your package service provider's `boot` method. From within your routes file, you may use the `Route` facade to [register routes](routing.md) just as you would within a typical Laravel application:

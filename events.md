...
> {tip} When testing, it can be helpful to assert that certain events were fired without actually triggering their listeners. Laravel's [built-in testing helpers](mocking.md#mocking-events) makes it a cinch.

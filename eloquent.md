...
If you are using [read / write connections](database.md#read-write-connections), you may force the query to use the "write" connection with the following method:

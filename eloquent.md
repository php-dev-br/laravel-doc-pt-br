...
Of course, you should add the `deleted_at` column to your database table. The Laravel [schema builder](migrations.md) contains a helper method to create this column:

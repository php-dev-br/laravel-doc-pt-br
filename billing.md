...
Since Stripe webhooks need to bypass Laravel's [CSRF verification](routing.md#csrf-protection), be sure to list the URI as an exception in your `VerifyCsrfToken` middleware:

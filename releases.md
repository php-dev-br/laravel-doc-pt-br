...
For more information on Horizon, check out the [full Horizon documentation](horizon.md)
...
For more information on updating your packages to use service provider and facade discovery, check out the full documentation on [package development](packages.md).
...
Of course, this is only the most basic example of an API resource. Laravel also provides a variety of methods to help you when building your resources and resource collections. For more information, check out the [full documentation](eloquent-resources.md) on API resources.

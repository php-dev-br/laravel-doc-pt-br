...
Laravel 5.3 continues the improvements made in Laravel 5.2 by adding a driver based [notification system](notifications.md), robust realtime support via [Laravel Echo](broadcasting.md), painless OAuth2 servers via [Laravel Passport](passport.md), full-text model searching via [Laravel Scout](scout.md), Webpack support in Laravel Elixir, "mailable" objects, explicit separation of `web` and `api` routes, Closure based console commands, convenient helpers for storing uploaded files, support for POPO and single-action controllers, improved default frontend scaffolding, and more.
...
There is already a wide variety of [community written drivers](http://laravel-notification-channels.com) for notifications, including support for iOS and Android notifications. To learn more about notifications, be sure to check out the [full notification documentation](notifications.md).
...
To learn more about Echo and event broadcasting, check out the [full documentation](broadcasting.md).
...
Lastly, Passport includes support for consuming your own API from your JavaScript application without worrying about passing access tokens. Passport achieves this through encrypted JWT cookies and synchronized CSRF tokens, allowing you to focus on what matters: your application. For more information on Passport, be sure to check out its [full documentation](passport.md).

### Search (Laravel Scout)

Laravel Scout provides a simple, driver based solution for adding full-text search to your [Eloquent models](eloquent.md). Using model observers, Scout will automatically keep your search indexes in sync with your Eloquent records. Currently, Scout ships with an [Algolia](https://www.algolia.com/) driver; however, writing custom drivers is simple and you are free to extend Scout with your own search implementations.
...
Of course, Scout has many more features which are covered in the [full documentation](scout.md).
...
For more information on mailable objects, be sure to check out the [mail documentation](mail.md).
...
For more information on Closure commands, check out the [full Artisan documentation](artisan.md#closure-commands).
...
For more information, consult the [full Blade documentation](blade.md#the-loop-variable).
...
For more information on writing global scopes, check out the full [Eloquent documentation](eloquent.md#global-scopes).

<a name="laravel-5.1.11"></a>
## Laravel 5.1.11

Laravel 5.1.11 introduces [authorization](authorization.md) support out of the box! Conveniently organize your application's authorization logic using simple callbacks or policy classes, and authorize actions using simple, expressive methods.

For more information, please refer to the [authorization documentation](authorization.md).

<a name="laravel-5.1.4"></a>
## Laravel 5.1.4

Laravel 5.1.4 introduces simple login throttling to the framework. Consult the [authentication documentation](authentication.md#authentication-throttling) for more information.
...
To learn more about event broadcasting, check out the [event documentation](events.md#broadcasting-events).
...
For more information on middleware, check out the [middleware documentation](middleware.md).
...
For more information on testing, check out the [testing documentation](testing.md).
...
For more information on defining Artisan commands, consult the [Artisan documentation](artisan.md).
...
For more information on contracts, consult the [full documentation](contracts.md).
...
For more information on middleware, check out [the documentation](middleware.md).

### Controller Method Injection

In addition to the existing constructor injection, you may now type-hint dependencies on controller methods. The [service container](container.md) will automatically inject the dependencies, even if the route contains other parameters:
...
For more information on working with events, check out the [full documentation](events.md).
...
Of course, check out the [full documentation](scheduling.md) to learn all about the scheduler!
...
For more information on Elixir, check out the [full documentation](elixir.md).
...
No more spending hours writing OAuth authentication flows. Get started in minutes! The [full documentation](authentication.md#social-authentication) has all the details.
...
For more information on the Laravel Flysystem integration, consult the [full documentation](filesystem.md).
...
For more information on this new method, check out [the documentation](validation.md#validation-quickstart).

...
Laravel allows you to not only route to Closures, but also to controller classes, and even allows the creation of [resource controllers](controllers.md#restful-resource-controllers).

...
If you are sending mail in this way you should convert these calls to [mailables](mail.md).
...
Once you have created this class, make sure to update all of your tests to extend your new `BrowserKitTestCase` class. This will allow all of your tests written on Laravel 5.3 to continue running on Laravel 5.4. If you choose, you can slowly begin to port them over to the new [Laravel 5.4 test syntax](http-tests.md) or [Laravel Dusk](dusk.md).
...
Once you have completed these preparatory steps, you can follow the normal [Dusk installation instructions](dusk.md#installation).

...
The `Jobs` directory, of course, houses the [queueable jobs](queues.md) for your application. Jobs may be queued by your application, as well as be run synchronously within the current request lifecycle.
